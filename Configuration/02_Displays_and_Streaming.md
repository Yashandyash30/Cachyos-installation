...
if installtion prompts for package conflicts ( cachyos and arch repo)  particularly  `cuda`  `libva-mesa-driver` etc don't reinstall them just halt  the installtion and remove those from above line
